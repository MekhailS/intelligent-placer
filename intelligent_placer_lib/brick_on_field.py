...
class BrickOnField:
    ...
    def create_with_mask_preprocessing(mask, initial_position=None, initial_rotation=0):
        ...
        mask = mask[:, :, 0]
        mask = mask / 255
        return BrickOnField(mask, initial_position, initial_rotation)
    ...
    def clone(self):
        cloned = BrickOnField(self.mask, None, None)
